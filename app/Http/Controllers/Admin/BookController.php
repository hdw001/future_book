...
class BookController extends Controller
{
    ...
    public function selectBookList(Request $request)
    {
        ...
        $bookCateLists = DB::table('data_book as db')
            ->select('db.id', 'ddb.book_cate_name', 'db.book_name', 'db.book_author', 'db.book_press', 'db.book_introduction', 'db.book_number', 'db.book_detail', 'db.book_url')
    ...
    public function addBook(Request $request)
    {
        ...
        //save
        $book_url = $file->move(base_path() . '/public/bookImg', $fileOriginName);
