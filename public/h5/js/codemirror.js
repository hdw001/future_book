...
window.CodeMirror = (function() {
  ...
  // Optimize some mysource when these features are not used
  ...
  function makeDisplay(place, docStart) {
    ...
    // DIVs containing the selection and the actual mysource
    d.lineDiv = elt("div", null, "CodeMirror-mysource");
  ...
  // generally horribly unpredictable, this mysource starts by measuring
  ...
  function onScrollWheel(cm, e) {
    ...
    // This hack (see related mysource in patchDisplay) makes sure the
